...
class TaskOneTests {
  ...
  void task_one_verifier() throws InterruptedException {
    ...
    logger.info("--------------------------");
    logger.info("--------------------------");
    logger.info("Congrats! It look like your application booted without issue");
    logger.info("submit the following outputs to complete the task (including begin and end output denotations)");
